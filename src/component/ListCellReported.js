...
export default class ListCellReported extends Component {
    constructor(props) {
        super(props);
        this.state = {
            filter: false,
            ...
            <View style={{ height: '100%', backgroundColor: 'white' }}>
                ...
                <ImageBackground source={require('../pictures/header.png')} style={{ height: 140 }} resizeMode='stretch'>
                    <View style={{ justifyContent: 'center' }}>
                        <Text style={styles.bigWhite}>Danh sách phản ánh</Text>
                    </View>
                                ...
                                <View>
                                    {item.name.includes(this.state.search) ?
                                        <View style={{ marginTop: 5, paddingHorizontal: 20 }}>
                                            <TouchableOpacity style={{ padding: 5, height: 75, borderColor: '#B8D9E9', borderWidth: 1, borderRadius: 7, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} onPress={() => this.props.navigation.navigate('ReportDetail')}>
                                                ...
                                                <View style={{ height: '100%', width: '70%', justifyContent: 'space-between' }}>
                                                    <View>
                                                        ...
                                                        <Text style={{ fontSize: 10, color: '#666666' }}>Mã PA</Text>
                                                        <Text style={{ fontSize: 10, color: '#666666' }}>Trạng thái</Text>
                                                    </View>
                                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                            <Image source={require('../pictures/user.png')} style={{ width: 10, height: 10 }} resizeMode='contain' />
                                                            <Text style={{ fontSize: 10 }}> userPA</Text>
                                                        </View>
                                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View style={{ position: 'absolute', height: '100%', width: '100%', backgroundColor: '#666666B3', elevation: 6, alignItems: 'center', justifyContent: 'center' }} >
                            <View style={{ backgroundColor: 'white', borderRadius: 15 }}>
                                ...
                                <View style={{ paddingHorizontal: 20, paddingVertical: 10 }}>
                                    <Text style={{ fontSize: 12, fontWeight: 'bold', color: '#666666' }}>Trạng thái PA:</Text>
                                    <View style={{ ...styles.textBox, padding: 0, justifyContent: 'center' }}>
                                        ...
                                        >
                                            <Picker.Item style={{ fontSize: 13 }} label='Tất cả' value=' ' color='#A5A4A4' backgroundColor='white' />
